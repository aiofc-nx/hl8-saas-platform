/**
 * FastifyLoggerMiddleware 单元测试
 *
 * @description 测试 FastifyLoggerMiddleware 类的功能
 * 包括请求/响应日志记录、上下文绑定、错误处理等功能
 */

import { FastifyRequest, FastifyReply, FastifyInstance } from 'fastify';
import { FastifyLoggerMiddleware, FastifyLoggerMiddlewareOptions } from './fastify-middleware';
...
describe('FastifyLoggerMiddleware', () => {
  let middleware: FastifyLoggerMiddleware;
  ...
  describe('构造函数', () => {
    it('应该使用默认选项创建中间件', () => {
      middleware = new FastifyLoggerMiddleware();
    ...
    it('应该使用自定义选项创建中间件', () => {
      ...
      middleware = new FastifyLoggerMiddleware(options);
  ...
  describe('日志级别控制', () => {
    it('应该使用指定的日志级别', () => {
      ...
      expect(middleware['logger']).toBeInstanceOf(FastifyLogger);
    });
