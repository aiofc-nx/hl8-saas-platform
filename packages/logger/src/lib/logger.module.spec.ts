...
describe('LoggerModule', () => {
  ...
  describe('forRoot', () => {
    ...
    it('应该提供 LOGGER_PROVIDER 实例', async () => {
      ...
      const logger = module.get<FastifyLogger>(LOGGER_PROVIDER);
    ...
    it('应该提供中间件当启用请求日志时', async () => {
      ...
      const middleware = module.get<FastifyLoggerMiddleware>('FASTIFY_LOGGER_MIDDLEWARE');
      expect(middleware).toBeDefined();
      expect(middleware).toBeInstanceOf(FastifyLoggerMiddleware);
    });
